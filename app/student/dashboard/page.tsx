      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-600">Total Points</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-600">Documents Uploaded</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Upload marksheets or certificates for evaluation
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <FileText className="w-5 h-5" /> Your Submissions
            </CardTitle>
          </CardHeader>
